...
后端 Java、接口、Nacos、PromptId 来源和影响分析不属于本 Skill。维护人员需要这些信息时，阅读 goffer 的 `openspec/changes/refactor-resume-ai-help-skill/` 和 `explore-resume-ai-help/`；不要把它们加入学员执行流程。
